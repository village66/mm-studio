...
const renovation02 =
  "/images/projects/renovation/renovation-02";
const renovation03 =
  "/images/projects/renovation/renovation-03";
const commercial01 =
    ...
    cases: [
      {
        ...
        phases: [
          ...
          phase(
            "progress",
            "從庭院整地、鋼構加工與吊裝，到外牆修整、格柵安裝及室內拆除重整，逐步完成老宅內外介面的更新。",
            makeNumberedImages(
              renovation01,
              "progress",
              [
      ...
      },
      {
        ...
        storyZh:
          "重新梳理高樓住宅的公共空間、入口與收納關係，以淺色木地板放大自然光感，搭配深色電視牆、藍色端景與窗邊臥榻，讓開闊景觀成為日常生活的核心。",
        storyEn:
          "A high-rise home renewed around panoramic light and everyday storage, balancing pale timber flooring with dark built-ins, a blue focal wall and a generous window bench.",
        phases: [
          phase(
            "before",
            "原始住宅以磁磚地坪、封閉廚房與分散收納為主，公共空間雖具良好採光與景觀，動線與視覺仍有重新整合的空間。",
            makeNamedImages(
              renovation02,
              "before",
              [
          ...
          phase(
            "completed",
            "淺色木地板串聯客餐廳，深色收納牆整合影音機能，入口端景、窗邊臥榻與更新後廚房共同建立明亮俐落的生活場景。",
            makeNumberedImages(
              renovation02,
              "completed",
              [
      ...
      },
      {
        ...
        phases: [
          phase(
            "before",
            "原始空間保留既有磁磚、設備與家具配置，部分區域收納密集，外牆、衛浴、廚房及室內動線皆納入本次翻修範圍。",
            makeNamedImages(
              renovation03,
              "before",
              [
                "39880_0.jpg",
                "62CF3784-845E-487D-AEB0-76A34F9B1FD2.jpg",
                "8D455BC5-EDD9-4075-B389-DC89858FDEF2.jpg",
                "A9E80587-6469-4250-A4C6-CF570A3EDB39.jpg",
                "AB767F43-7F61-436B-92FE-0033877F3476.jpg",
                "LINE_ALBUM_逢甲-葉宅翻修_240315_3.jpg",
                "LINE_ALBUM_逢甲-葉宅翻修_240315_7.jpg",
                "LINE_ALBUM_逢甲-葉宅翻修_240408_4.jpg",
                "LINE_ALBUM_逢甲-葉宅翻修_240408_7.jpg",
              ],
              [
                "改造前樓梯、扶手與入口收納現況",
                "原有衛浴設備、磁磚與置物區配置",
          ...
          phase(
            "progress",
            "施工過程涵蓋屋頂、外牆、室內拆除、泥作、防水、衛浴、廚房及固定收納，依序完成基礎工程與表面收整。",
            makeNamedImages(
              renovation03,
              "progress",
              [
          ...
          phase(
            "completed",
            "完工空間以白色牆面與淺木地板統一公共區域，廚房、衛浴、臥室與收納同步更新，並保留自然採光與既有家具的使用需求。",
            makeNamedImages(
              renovation03,
              "completed",
              [
